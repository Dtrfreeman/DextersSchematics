puts "***********************************"
puts "*"
puts "* X-FAB RTL2GDS with openroad started"
puts "*"
puts "* WARNING: "
...
set yosys_params "$::env(SCRIPT_DIR)/synth-xfab.tcl"
...
global_placement -disable_routability_driven -density 1  -init_density_penalty 8e-5 -pad_left 3 -pad_right 3
# -skip_initial_place
