...
source "$::env(PDK_ROOT)/$::env(PDK)/libs.tech/LayoutEditor/tools.tcl"


# no pad for power nets
removeBTerm "VNB" "VPB" "VGND" "VPWR"
...
#initialize_floorplan  -site $site -utilization 10 -aspect_ratio 1 -core_space 5 -tracks $tracks_file
...
global_placement -disable_routability_driven -density 1  -init_density_penalty 8e-5 -pad_left 4 -pad_right 4 -skip_initial_place
