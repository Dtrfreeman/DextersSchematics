...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.6.0/x64-mswin64_140")
  ...
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "c:/layout64/ruby")
  CONFIG["EXEEXT"] = ".exe"
  CONFIG["ruby_install_name"] = "ruby"
  CONFIG["RUBY_INSTALL_NAME"] = "ruby"
  CONFIG["RUBY_SO_NAME"] = "x64-vcruntime140-ruby260"
  ...
  CONFIG["configure_args"] = "--with-make-prog=nmake --enable-shared --prefix=c:\\layout64\\ruby --target=x64-mswin64"
